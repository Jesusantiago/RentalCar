...
public class RentalResponseDTO {
    ...
    public RentalResponseDTO(Long rentalId, LocalDateTime startDate, LocalDateTime endDate, BigDecimal price, StatusRental status, Long carId, Long clientId, Long branchFromId, Long branchToId) {
